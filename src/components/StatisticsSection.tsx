  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-20 font-sans">
        ...
        <p className="text-zinc-550 dark:text-zinc-400 text-xs animate-pulse">მიმდინარეობს სტატისტიკის დამუშავება...</p>
      </div>
    );
  }
  ...
  return (
    <div id="statistics-section" className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-xl font-bold text-zinc-850 dark:text-zinc-150 font-sans tracking-tight">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-805 rounded-2xl p-4 flex items-center gap-3">
          ...
          <div>
            <span className="block text-[10px] text-zinc-405 dark:text-zinc-500 font-sans uppercase font-bold">დაწყებული ტესტები</span>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-805 rounded-2xl p-4 flex items-center gap-3">
          ...
          <div>
            <span className="block text-[10px] text-zinc-405 dark:text-zinc-500 font-sans uppercase font-bold">დასრულებული</span>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-805 rounded-2xl p-4 flex items-center gap-3">
          ...
          <div>
            <span className="block text-[10px] text-zinc-405 dark:text-zinc-500 font-sans uppercase font-bold">საშუალო ქულა</span>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-805 rounded-2xl p-4 flex items-center gap-3">
          ...
          <div>
            <span className="block text-[10px] text-zinc-405 dark:text-zinc-500 font-sans uppercase font-bold">ნაპასუხები კითხვები</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 shadow-xs flex flex-col justify-between">
          <div>
            <h3 className="text-sm font-semibold font-sans text-zinc-800 dark:text-zinc-150 mb-4 flex items-center gap-1.5 border-b border-zinc-100 dark:border-zinc-805 pb-3">
          ...
          <div className="bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-805 rounded-xl p-3 text-xs font-sans text-zinc-500 mt-6 leading-relaxed">
